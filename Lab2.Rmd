...
remember we must load the plink module using `module load plink/1.90p`
...
```
plink --bfile Ethiopians_All_UpdateSex_Sort --extract EthiopiansAll_LD050.prune.in --make-bed --out EthiopiansAll_LDpruned050
```
