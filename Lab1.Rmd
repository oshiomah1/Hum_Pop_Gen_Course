...
Write the full code to filter SNPs using the  `--geno` flag on the `Ethiopians_chr1`  binary file you created using a genotyping QC command specifying that a SNP can have at most 5%
missing data? Your output file should be called `Ethiopians_chr1_Geno_5pct`
